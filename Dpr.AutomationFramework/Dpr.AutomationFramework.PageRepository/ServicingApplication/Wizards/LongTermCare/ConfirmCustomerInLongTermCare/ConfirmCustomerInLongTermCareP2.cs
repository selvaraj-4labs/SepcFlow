...
{
    public class ConfirmCustomerInLongTermCareP2 : AppBasePage
    {
        public ConfirmCustomerInLongTermCareP2()
        {
            pageLoadedElement = dailyActivitiesLetterRequiredRbtn;
            correspondingDataClass = new ConfirmCustomerInLongTermCareP2Data().GetType();
            textName = "Confirm Customer In Long Term Care Page 2";
        }
    ...
    public class ConfirmCustomerInLongTermCareP2Data : PageData
    {
