...
{
    public class ConfirmCustomerDeceasedP2 : AppBasePage
    {
        public ConfirmCustomerDeceasedP2()
        {
            pageLoadedElement = grantOfProbateRecievedRequiredRbtn;
            correspondingDataClass = new ConfirmCustomerDeceasedP2Data().GetType();
            textName = "Confirm Customer Deceased Page 2";
        }
    ...
    public class ConfirmCustomerDeceasedP2Data : PageData
    {
        #region 'Grant Of Probate Recieved?' Section
