...
{
    public class FMA_Applicant1PrimaryEmploymentPageEmployed : WebBasePage
    {
        public FMA_Applicant1PrimaryEmploymentPageEmployed()
        {
            pageLoadedElement = employmentStatus;
            correspondingDataClass = new FMA_Applicant1PrimaryEmploymentPageEmployedData().GetType();
            ...
            pageCondition = new PageCondition(new Element(new ConditionList()
                .Add(new Condition("DIP_ApplicationSummaryPage", "_app1EmploymentType", "Employed"))));
        }
    ...
    public class FMA_Applicant1PrimaryEmploymentPageEmployedData : PageData
    {
