...
{
    public class Applicant1CreditCommitmentsPage : WebBasePage
    {
        public Applicant1CreditCommitmentsPage()
        {
            pageLoadedElement = applicantHaveCreditOrStoreCardsRbtn;
            correspondingDataClass = new Applicant1CreditCommitmentsPageData().GetType();
            textName = "Applicant 1 Credit Commitments Page";
        }
        ...
        public Element existingResidentialMortgageRedeemedRbtn => new Element(new RadioButton()
            ...
            new ConditionList()
            .Add(new Condition("Applicant1AddressHistoryPage", "residentialStatus", "Owner Unencumbered")))
            .AddNewConditionList(new ConditionList()
            .Add(new Condition( "Applicant1AddressHistoryPage", "residentialStatus", "Owner With Mortgage")));

        public Element estimatedValueOfCurrentResidentialPropertyBox => new Element(FindElement("ApplicantPanel_ctl00_CurrentMortgageValue"),
            new ConditionList()
            .Add(new Condition("Applicant1AddressHistoryPage", "residentialStatus", "Owner Unencumbered")))
            .AddNewConditionList(new ConditionList()
            .Add(new Condition("Applicant1AddressHistoryPage", "residentialStatus", "Owner With Mortgage")));
        ...
        public Element monthlyRentalPaymentBox => new Element(FindElement("TenancyPayment"),
            new ConditionList()
            .Add(new Condition("Applicant1AddressHistoryPage", "residentialStatus", "Renting - Private Landlord")))
            .AddNewConditionList(new ConditionList()
            .Add(new Condition("Applicant1AddressHistoryPage", "residentialStatus", "Renting - Local Authority or Social Landlord")))
            .AddNewConditionList(new ConditionList()
            .Add(new Condition("Applicant1AddressHistoryPage", "residentialStatus", "Renting - Letting Agent")));
        ...
        public Element next => new Element(FindElement("ctl04_Next"))
            .SetIsButtonFlag(true)
            .SetIsPageContinueButtonFlag(true);

    }

    public class Applicant1CreditCommitmentsPageData : PageData
    {
