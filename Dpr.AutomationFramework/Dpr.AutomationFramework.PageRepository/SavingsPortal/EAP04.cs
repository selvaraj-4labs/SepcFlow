...
{
    public class EAP04 : WebBasePage
    {
        public EAP04()
        {
            pageLoadedElement = titleLookup;
            correspondingDataClass = new EAP04Data().GetType();
            textName = "About You";
        ...
        public Element singleJointAccountRbtn => new Element(new RadioButton()
            ...
            new ConditionList()
            .Add(new Condition("ProductSelection", "productType", "ISA", Defs.conditionTypeNotEqual))
        ...
        public Element accountNumberBox => new Element(FindElement("AccountNumberTextBox"), 
            new ConditionList()
                .Add(new Condition(className, "existingBankMemberRbtn", Defs.radioButtonYes))
                .Add(new Condition("ProductSelection", "productType", "Child", Defs.conditionTypeNotEqual))
                .Add(new Condition(className, "dateOfBirth", ">=16", Defs.conditionTypeCompareYearDifferenceDdMmYyyy)));
        ...
        */
        ...
        public Section employmentDetailsSection => new Section(new Element(
            new ConditionList()
                .Add(new Condition(className, "dateOfBirth", ">=16", Defs.conditionTypeCompareYearDifferenceDdMmYyyy))));
    ...
    public class EAP04Data : PageData
    {
        public EAP04Data()
        {
