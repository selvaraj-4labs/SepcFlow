...
{
    public class CBS_ADV_DIP09_FTC_3 : CBS_DIP09_FTC_3
    {
        public CBS_ADV_DIP09_FTC_3()
        {
            pageLoadedElement = fullTime;
            correspondingDataClass = new CBS_ADV_DIP09_FTC_3Data().GetType();
            textName = "CBS Advised Applicant 3 Primary Employment Page - Fixed Term Contract";
            pageCondition = new PageCondition(new Element(
                new ConditionList()
                    .Add(new Condition("CBS_ADV_DIP06", "numberOfApplicants", "3"))
                    .Add(new Condition("CBS_ADV_DIP08_3", "employmentStatus", "Fixed Term Contract")))
    ...
    public class CBS_ADV_DIP09_FTC_3Data : CBS_DIP09_FTC_3Data
    {
    }
}
