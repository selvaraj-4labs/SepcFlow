...
{
    public class CBS_ADV_DIP09_SelfEmployed_4 : CBS_DIP09_SelfEmployed_4
    {
        public CBS_ADV_DIP09_SelfEmployed_4()
        {
            pageLoadedElement = fullTime;
            correspondingDataClass = new CBS_ADV_DIP09_SelfEmployed_4Data().GetType();
            textName = "CBS Advised Applicant 4 Primary Employment Page - Self Employed";
            pageCondition = new PageCondition(new Element(
                new ConditionList()
                    .Add(new Condition("CBS_ADV_DIP06", "numberOfApplicants", "4"))
                    .Add(new Condition("CBS_ADV_DIP08_4", "employmentStatus", "Self Employed"))));
        }
    ...
    public class CBS_ADV_DIP09_SelfEmployed_4Data : CBS_DIP09_SelfEmployed_4Data
    {
    }
}
