...
{
    public class CBS_ADV_DIP01 : WebBasePage
    {
        public CBS_ADV_DIP01()
        {
            pageLoadedElement = applicantOverRequiredAge;
            correspondingDataClass = new CBS_ADV_DIP01Data().GetType();
            textName = "CBS Advised Pre-Requisite Questions Page";
        }

        #region 'Pre-requisite questions' Section
        ...
        #region 'GDPR Declaration' Section
    ...
    public class CBS_ADV_DIP01Data : PageData
    {
