...
{
    public class CBS_ADV_DIP09_FTC_4 : CBS_DIP09_FTC_4
    {
        public CBS_ADV_DIP09_FTC_4()
        {
            pageLoadedElement = fullTime;
            correspondingDataClass = new CBS_ADV_DIP09_FTC_4Data().GetType();
            textName = "CBS Advised Applicant 4 Primary Employment Page - Fixed Term Contract";
            pageCondition = new PageCondition(new Element(
                new ConditionList()
                    .Add(new Condition("CBS_ADV_DIP06", "numberOfApplicants", "4"))
                    .Add(new Condition("CBS_ADV_DIP08_4", "employmentStatus", "Fixed Term Contract"))));
        }
    ...
    public class CBS_ADV_DIP09_FTC_4Data : CBS_DIP09_FTC_4Data
    {
    }
}
