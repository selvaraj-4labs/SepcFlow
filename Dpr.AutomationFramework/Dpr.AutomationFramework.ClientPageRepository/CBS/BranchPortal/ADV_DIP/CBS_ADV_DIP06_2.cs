...
{
    public class CBS_ADV_DIP06_2 : CBS_ADV_DIP06
    {
        public CBS_ADV_DIP06_2()
        {
            pageLoadedElement = title;
            correspondingDataClass = new CBS_ADV_DIP06_2Data().GetType();
            textName = "CBS Advised Applicant 2 Details Page";
        ...
        public Element relationshipWithMainApplicant => new Element(FindElement("cboRelationshipToBorrower", tag: "select"));
    ...
    public class CBS_ADV_DIP06_2Data : CBS_ADV_DIP06Data
    {
