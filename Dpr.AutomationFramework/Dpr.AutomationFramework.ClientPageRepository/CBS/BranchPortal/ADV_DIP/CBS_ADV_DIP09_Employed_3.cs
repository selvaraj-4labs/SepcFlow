...
{
    public class CBS_ADV_DIP09_Employed_3 : CBS_DIP09_Employed_3
    {
        public CBS_ADV_DIP09_Employed_3()
        {
            pageLoadedElement = fullTime;
            correspondingDataClass = new CBS_ADV_DIP09_Employed_3Data().GetType();
            textName = "CBS Advised Applicant 3 Primary Employment Page - Employed";
            pageCondition = new PageCondition(new Element(
                new ConditionList()
                    .Add(new Condition("CBS_ADV_DIP06", "numberOfApplicants", "3"))
                    .Add(new Condition("CBS_ADV_DIP08_3", "employmentStatus", "Employed")))
    ...
    public class CBS_ADV_DIP09_Employed_3Data : CBS_DIP09_Employed_3Data
    {
    }
}
