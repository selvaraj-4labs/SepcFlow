...
{
    public class CBS_ADV_DIP09_SelfEmployed_2 : CBS_DIP09_SelfEmployed_2
    {
        public CBS_ADV_DIP09_SelfEmployed_2()
        {
            pageLoadedElement = fullTime;
            correspondingDataClass = new CBS_ADV_DIP09_SelfEmployed_2Data().GetType();
            textName = "CBS Advised Applicant 2 Primary Employment Page - Self Employed";
            pageCondition = new PageCondition(new Element(
                new ConditionList()
                    .Add(new Condition("CBS_ADV_DIP06", "numberOfApplicants", "2"))
                    .Add(new Condition("CBS_ADV_DIP08_2", "employmentStatus", "Self Employed")))
    ...
    public class CBS_ADV_DIP09_SelfEmployed_2Data : CBS_DIP09_SelfEmployed_2Data
    {
    }
}
