...
{
    public class CBS_ADV_DIP09_FTC_2 : CBS_DIP09_FTC_2
    {
        public CBS_ADV_DIP09_FTC_2()
        {
            pageLoadedElement = fullTime;
            correspondingDataClass = new CBS_DIP09_FTC_2Data().GetType();
            textName = "CBS Advised Applicant 2 Primary Employment Page - Fixed Term Contract";
            pageCondition = new PageCondition(new Element(
                new ConditionList()
                    .Add(new Condition("CBS_ADV_DIP06", "numberOfApplicants", "2"))
                    .Add(new Condition("CBS_ADV_DIP08_2", "employmentStatus", "Fixed Term Contract")))
    ...
    public class CBS_ADV_DIP09_FTC_2Data : CBS_DIP09_FTC_2Data
    {
    }
}
