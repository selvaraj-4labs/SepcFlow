...
{
    public class CBS_DIP09_FTC : WebBasePage
    {
        public CBS_DIP09_FTC()
        {
            pageLoadedElement = fullTime;
            correspondingDataClass = new CBS_DIP09_FTCData().GetType();
            textName = "CBS Applicant 1 Primary Employment Page - Fixed Term Contract";
            pageCondition = new PageCondition(new Element(
                new ConditionList()
                    .Add(new Condition("CBS_DIP08", "employmentStatus", "Fixed Term Contract"))));
        }
    ...
    public class CBS_DIP09_FTCData : PageData
    {
