...
{
    public class CBS_DIP06_2 : CBS_DIP06
    {
        public CBS_DIP06_2()
        {
            pageLoadedElement = title;
            correspondingDataClass = new CBS_DIP06_2Data().GetType();
            textName = "CBS Applicant 2 Details Page";
    ...
    public class CBS_DIP06_2Data : CBS_DIP06Data
    {
