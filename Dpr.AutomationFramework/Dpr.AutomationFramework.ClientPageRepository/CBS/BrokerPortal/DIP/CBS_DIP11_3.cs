...
{
    public class CBS_DIP11_3 : CBS_DIP11
    {
        public CBS_DIP11_3()
        {
            pageLoadedElement = applicantHaveMortgageOrSecuredLoansRbtn;
            correspondingDataClass = new CBS_DIP11_3Data().GetType();
            textName = "CBS Applicant 3 Credit Commitments Page";
    ...
    public class CBS_DIP11_3Data : CBS_DIP11Data
    {
    }
}
